            ...
            raw.append(
                {
                    ...
                    "sales": camp.get("sales"),
                    "expense": camp.get("expense"),
                    "views": camp.get("views"),
                    "clicks": camp.get("clicks"),
                    "to_cart": camp.get("to_cart"),
                    "model_orders": camp.get("model_orders"),
                    "model_sales": camp.get("model_sales"),
